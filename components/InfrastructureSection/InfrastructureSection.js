    ...
    <section ref={container} className="py-24 bg-carbon relative border-y border-white/10">
      ...
      <div className="container mx-auto px-4 relative z-10">
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
          {/* Card 1 */}
          <div className="infra-card glass-panel p-8 group hover:-translate-y-1 transition-transform duration-300 cursor-default">
            <div className="w-12 h-12 bg-graphite border border-white/10 rounded-sm flex items-center justify-center mb-6 group-hover:border-cian transition-colors">
            ...
            <p className="text-cyber font-mono text-sm leading-relaxed mb-4">
              Local game caching and dedicated routing tables ensure sub-1ms pings to regional match-making servers.
            </p>
            <div className="h-[1px] w-full bg-white/10 mb-4 group-hover:bg-cian/50 transition-colors"></div>
            <span className="text-cian font-mono text-xs uppercase tracking-widest">99.99% Uptime SLA</span>
          </div>
          ...
          <div className="infra-card glass-panel p-8 group hover:-translate-y-1 transition-transform duration-300 cursor-default">
            ...
            <div className="h-[1px] w-full bg-white/10 mb-4 group-hover:bg-cian/50 transition-colors"></div>
            <span className="text-cian font-mono text-xs uppercase tracking-widest">Zero Packet Loss</span>
          </div>
          ...
          <div className="infra-card glass-panel p-8 group hover:-translate-y-1 transition-transform duration-300 cursor-default">
            ...
            <div className="h-[1px] w-full bg-white/10 mb-4 group-hover:bg-cian/50 transition-colors"></div>
            <span className="text-cian font-mono text-xs uppercase tracking-widest">Thermal Stability</span>
          </div>
        </div>
