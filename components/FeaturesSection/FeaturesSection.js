    ...
    <section ref={container} className="py-20 bg-carbon relative">
      <div className="container mx-auto px-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 items-stretch">
          {/* Ticker 1: LAN Event */}
          <div className="ticker-item glass-panel relative overflow-hidden group cursor-pointer hover:border-cian/50 transition-colors duration-300 min-h-[250px] flex flex-col justify-end p-8 h-full">
          ...
          {/* Ticker 2: Shop Offer */}
          <div className="ticker-item glass-panel relative overflow-hidden group cursor-pointer hover:border-tactical/50 transition-colors duration-300 min-h-[250px] flex flex-col justify-end p-8 h-full">
